...
"string"&&(e=a.prefilled.split(","),b.each(e,function(a,b){l(b,c)}))})}})(jQuery);function nospaces(b){if(b.value.match(/\s/g))b.value=b.value.replace(/\s/g,"")};
